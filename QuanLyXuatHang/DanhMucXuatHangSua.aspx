                    ...
                    <form class="form-horizontal" runat="server">
                            ...
                            <tr>
                                <td style="width: 30%;" valign="top">
                                    <div class="box" style="padding: 4px 4px 4px 4px;">
                                         <h4 style="text-align:center;"><b>Thông tin Đơn bán</b></h4>
                                        <b>Mã phiếu xuất(*):</b>
                                        ...
                                        <b>Ngày giao(*):</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="txtNgayGiao" runat="server" name="Content.ContentName" type="text" value="" />&nbsp;<br />
                                        <b>Xuất từ kho(*):</b>
                                ...
                                <td style="width: 30%;" valign="top">
                                    <div class="box" style="padding: 4px 4px 4px 4px;">
                                        <h4 style="text-align:center;"><b>Thông tin khách hàng</b></h4>
                                        <b>Loại ĐT:</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="txtLoaiDT" runat="server" name="Content.ContentName" type="text" value="" />&nbsp;
                                        <br />
                                        <b>Địa chỉ:</b>
                                        <input placeholder="" class="form-control" data-val="true" data-val-required="" id="txtDiaChi" runat="server" name="Content.ContentName" type="text" value="" />
                                        <br />
                                        <b>Điện thoại:</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="txtSDT" runat="server" name="Content.ContentName" type="text" value="" />&nbsp;<br />
                                        <b>Mã số thuế:</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="txtMaSoThue" runat="server" name="Content.ContentName" type="text" value="" />&nbsp;<br />
                                        <b>Email:</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="txtEmail" runat="server" name="Content.ContentName" value="" placeholder="" />
                                        <br />
                                        <b>Số tài khoản:</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="txtSoTaiKhoan" runat="server" name="Content.ContentName" value="" placeholder="" />
                                        <br />
                                        <div class="form-group" style="display: none;">
                                            <div class="row">
                                                <div class="dvnull">&nbsp;</div>
                                ...
                                <td style="width: 30%;" valign="top">
                                    <div class="box" style="padding: 4px 4px 4px 4px;">
                                        ...
                                        <br />
                                        <b>Khách hàng:</b>
                                        <input placeholder="--Chọn--" class="form-control" data-val="true" data-val-required="" id="Text2" runat="server" name="Content.ContentName" type="text" value="" readonly="true" />
                                        <input placeholder="--Chọn--" class="form-control" data-val="true" data-val-required="" id="Hidden1" runat="server" name="Content.ContentName" type="hidden" value="" /><br />
                                        <b>Ngày bán:</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="Text3" runat="server" name="Content.ContentName" type="text" value="" />&nbsp;<br />
                                        <b>Xuất từ kho:</b>
                                        <input class="form-control" data-val="true" data-val-required="" id="Hidden2" runat="server" name="Content.ContentName" type="hidden" value="" placeholder="--Chọn--" />
                                        <select class="form-control" data-val="true" data-val-required="" id="Select2" runat="server" name="Content.ContentName" type="text"></select>
                                        <b>Ghi chú:</b>
                                        <textarea class="form-control" id="Textarea1" name="Content.ContentName" runat="server"></textarea>
                                        <br />
                        ...
                        <div class="box" style="padding: 4px 4px 4px 4px;">
                            ...
                            <div id="dv2" style="text-align: center">
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="coninput1" style="display: none;">
                                            <div class="txtinput">
                                                <center>
                                                   <select onchange="LoadLoaiHang();" class="form-control" data-val="true" data-val-required="" id="Select1" runat="server" name="Content.ContentName"  >
                                                   </select>
                                                </center>
                                            </div>
                                        </div>
                                        <div class="coninput1">
                                            ...
                                            <div class="txtinput">
                                                <center>      
                                                   <input placeholder="--Chọn--" type="text" class="form-control" data-val="true" data-val-required="" id="txtLoaiHangHoa" runat="server" name="Content.ContentName" />
                                                </center>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="coninput1">
                                            ...
                                            <div class="txtinput">
                                                <center>     
                                                                <select  class="form-control" data-val="true" data-val-required="" id="slMauSac" runat="server" name="Content.ContentName"  >
                                                      </select></center>
                                                </center>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="coninput1">
                                            ...
                                            <div class="txtinput">
                                                <center>      
                                                       <input onkeyup="TinhTien2();"  class="form-control" data-val="true" data-val-required="" id="txtGiaDeNghi" runat="server" name="Content.ContentName"  />
                                                </center>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <br />
                                <center> 
                                    <a style="cursor:pointer;" onclick='ThemTheoLoaiHangHoa();' class="btn btn-primary btn-flat"><div >Thêm</div></a>
                                </center>
                                <br />
                            </div>
            ...
            <div id="dv" class="box-body">
                ...
                <div id="dv2" style="padding: 10px; text-align: center">
                    <div class="form-group">
                        ...
                        <center>
                            <select onchange="LoadLoaiHang();" class="form-control" data-val="true" data-val-required="" id="slLoaiHangCapCao" runat="server" name="Content.ContentName"  >
                            </select>
                        </center>
                    </div>
                    <div class="form-group">
