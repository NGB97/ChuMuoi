<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="BaoDangKyChungNhanPCCC.aspx.cs" Inherits="QuanLyXe_BaoDangKyChungNhanPCCC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">BÁO ĐĂNG KÝ CHỨNG NHẬN PCCC</div>
    <div class="box">
        <div class="box-body">
