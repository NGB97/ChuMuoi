<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="Kho.aspx.cs" Inherits="DanhMuc_DonViTinh" %>
      ...
      <script>
          ...
          function DeleteMauSac(IDMauSac) {
              if (confirm("Bạn có muốn xóa không ?")) {
                  ...
                  xmlhttp.open("GET", "../Ajax.aspx?Action=DeleteKho&IDMauSac=" + IDMauSac, true);
                  xmlhttp.send();
              }
          }
          //
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">DANH MỤC KHO</div>
    <div class="box">
        <div class="box-body">
            <div class="form-group">
                    <div class="row">
                        ...
                        <div class="coninput1">
                          <div class="titleinput"><b>Tên Kho:</b></div>
                          <div class="txtinput">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <a class="btn btn-primary btn-flat" href="Kho-CapNhat.aspx"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Thêm mới</a>
                </div>
                <div class="col-sm-3">
