<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DanhMucLoaiHangHoa.aspx.cs" Inherits="DanhMuc_DanhMucKhachHang" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        function XemChiTietMauSize(IDLoaiHangHoa) {
            var xmlhttp;
            if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
                xmlhttp = new XMLHttpRequest();
            }
            ...
            xmlhttp.open("GET", "../Ajax.aspx?Action=XemChiTietMauSize&IDLoaiHangHoa=" + IDLoaiHangHoa, true);
            xmlhttp.send();
        }
        //
        ...
        //
        function DeleteKhachHang(IDLoaiHangHoa) {
                ...
                xmlhttp.onreadystatechange = function () {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        if (xmlhttp.responseText == "True") {
                            ...
                            alert("Lỗi ràng buộc hãy xóa hết các màu và size trước khi xóa hàng hóa!")
                    }
                }
                xmlhttp.open("GET", "../Ajax.aspx?Action=DeleteLoaiHangHoa&IDLoaiHangHoa=" + IDLoaiHangHoa, true);
                xmlhttp.send();
            }
        }
        //
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">DANH MỤC HÀNG HÓA</div>
    <div class="box">
        <div class="box-body">
            <div class="form-group">
                    <div class="row">
                        ...
                        <div class="coninput1">
                          ...
                          <div class="txtinput">
                                <input placeholder="--Chọn--" class="form-control" data-val="true" data-val-required="" id="txtMaKhachHang" runat="server" name="Content.ContentName" type="text" value="" />
                          </div>
                        </div>
                       <div class="coninput1">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <a class="btn btn-primary btn-flat" href="DanhMucLoaiHangHoa-CapNhat.aspx"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Thêm mới</a>
                </div>
                <div class="col-sm-3">
