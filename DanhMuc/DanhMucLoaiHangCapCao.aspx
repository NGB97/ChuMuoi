<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DanhMucLoaiHangCapCao.aspx.cs" Inherits="DanhMuc_DanhMucHangHoa" %>
    ...
    <script>
        ...
        function DeleteHangHoa(IDHangHoa) {
            if (confirm("Bạn có muốn xóa không ?")) {
                ...
                xmlhttp.open("GET", "../Ajax.aspx?Action=DeleteLoaiHangCapCao&IDHangHoa=" + IDHangHoa, true);
                xmlhttp.send();
            }
        }
        //
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">DANH MỤC LOẠI HÀNG HÓA</div>
    <div class="box">
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <a class="btn btn-primary btn-flat" href="DanhMucLoaiHangCapCao-CapNhat.aspx"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Thêm mới</a>
                </div>
                <div class="col-sm-3">
