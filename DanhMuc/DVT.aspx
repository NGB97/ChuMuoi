<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DVT.aspx.cs" Inherits="DanhMuc_DonViTinh" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        window.onload = function () {
            //DonViTinhAutocomplete();
            //$("#ContentPlaceHolder1_txtTenKhachHang").val("--Chọn--");            
        }
        //
        function DeleteDonViTinh(IDDonViTinh)
        {
                ...
                xmlhttp.onreadystatechange = function () {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        if (xmlhttp.responseText == "True") {
                            ...
                            alert("Lỗi đơn vị tính này đã được dùng cho hàng hóa !")
                    }
                }
                xmlhttp.open("GET", "../Ajax2.aspx?Action=DeleteDVT&IDDonViTinh=" + IDDonViTinh, true);
                xmlhttp.send();
            }
        }
        //
        function DonViTinhAutocomplete() {
            var xmlhttp;
            if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
                xmlhttp = new XMLHttpRequest();
            }
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    if (xmlhttp.responseText != "") {
                        ...
                        $("#ContentPlaceHolder1_txtTenDonViTinh").autocomplete({

                            minLength: 0,
                            source: listKhachHangAutocomplete,
                            focus: function (event, ui) {
                                $("#ContentPlaceHolder1_txtTenDonViTinh").val(ui.item.label);
                                return false;
                            },
                            select: function (event, ui) {
                                $("#ContentPlaceHolder1_txtTenDonViTinh").val(ui.item.value);
            ...
            xmlhttp.open("GET", "../Ajax.aspx?Action=DonViTinhAutocomplete", true);
            xmlhttp.send();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">DANH MỤC ĐƠN VỊ TÍNH</div>
    <div class="box">
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <a class="btn btn-primary btn-flat" href="DVT-CapNhat.aspx"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Thêm mới</a>
                </div>
                <div class="col-sm-3">
