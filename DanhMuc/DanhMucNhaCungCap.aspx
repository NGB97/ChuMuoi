<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DanhMucNhaCungCap.aspx.cs" Inherits="DanhMuc_DanhMucNhaCungCap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        window.onload = function () {
            ...
            //LoadSoDienThoaiAutocomplete();
            
        }
        //
        function DeleteNhaCungCap(IDNhaCungCap)
        {
            ...
            {              
                ...
                xmlhttp.open("GET", "../Ajax.aspx?Action=DeleteNhaCungCap&IDNhaCungCap=" + IDNhaCungCap, true);
                xmlhttp.send();
            }
        }
        //
        function LoadSoDienThoaiAutocomplete() {
            var xmlhttp;
            if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
                xmlhttp = new XMLHttpRequest();
            }
            ...
            xmlhttp.open("GET", "../Ajax.aspx?Action=LoadSoDienThoaiAutocomplete", true);
            xmlhttp.send();
        }
        //
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box">
        <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="coninput1">
                          ...
                          <div class="txtinput">
                              ...
                              <input class="form-control" placeholder="--Chọn--" data-val="true" data-val-required="" id="idNCC" runat="server" name="Content.ContentName" type="hidden" value="" />
                          </div>
                        </div>
                        <div class="coninput1">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <a class="btn btn-primary btn-flat" href="DanhMucNhaCungCap-CapNhat.aspx"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Thêm mới</a>
                </div>
                <div class="col-sm-3">
