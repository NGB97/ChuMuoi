<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="KieuDang-CapNhat.aspx.cs" Inherits="DanhMuc_DonViTinh_CapNhat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <!-- Main content -->
        <div class="title" id="dvTitle" runat="server">THÊM THÔNG TIN KIỂU DÁNG</div>
        <div class="title1"><a href="KieuDang.aspx"><i class="fa fa-step-backward"></i>Danh sách kiểu dáng</a></div>
                    ...
                    <form class="form-horizontal" runat="server">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="coninput1">
                                    <div class="titleinput"><b>Mã kiểu dáng(*):</b></div>
                                    <div class="txtinput">
                                        <input class="form-control" data-val="true" data-val-required="" id="txtMaKieuDang" runat="server" name="Content.ContentName" type="text" value="" />
                                    </div>
                                </div>
                                <div class="coninput2">
