...
public partial class DanhMuc_DonViTinh : System.Web.UI.Page
{
    ...
    private void LoadDuAn()
    {
        ...
        for (int i = 0; i < table.Rows.Count; i++)
        {
            ...
            html += "       <td>" + table.Rows[i]["TenNhomHangHoa"] + "</td>"; 
            html += " <td style='text-align:center;font-size: 100%;'><a href='#' onclick='window.location=\"NhomHangHoa-CapNhat.aspx?Page=" + Page.ToString() + "&IDNhomHangHoa=" + table.Rows[i]["IDNhomHangHoa"].ToString() + "\"'><img title='Sửa' class='imgCommand' src='../Images/edit.png' onclick='window.location=\"NhomHangHoa-CapNhat.aspx?Page=" + Page.ToString() + "&IDNhomHangHoa=" + table.Rows[i]["IDNhomHangHoa"].ToString() + "\"' /> Sửa </a>";
            html += "|<a href='#' onclick='DeleteNhomHangHoa(\"" + table.Rows[i]["IDNhomHangHoa"] + "\")'><img title='Xóa' class='imgCommand' src='../Images/delete.png' onclick='DeleteNhomHangHoa(\"" + table.Rows[i]["IDNhomHangHoa"].ToString() + "\")' />Xóa</a></td>";
            html += "       </tr>";

        }
        html += "   <tr>";
        html += "       <td colspan='11' class='footertable'>";
        string url = "NhomHangHoa.aspx?";
        if (pTenNhomHangHoa != "")
