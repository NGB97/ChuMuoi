<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="Kho-CapNhat.aspx.cs" Inherits="DanhMuc_MauSac_CapNhat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <!-- Main content -->
    <div class="title" id="dvTitle" runat="server">THÊM THÔNG TIN KHO</div>
    <div class="title1"><a href="Kho.aspx"><i class="fa fa-step-backward"></i> Danh sách màu sắc</a></div>
            ...
            <form class="form-horizontal" runat="server">
               <div class="form-group">
                    <div class="row">
                        ...
                        <div class="coninput1">
                          <div class="titleinput"><b>Mã kho(*):</b></div>
                          <div class="txtinput">
