<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DanhMucKhachHangSanPhamChuyenGia.aspx.cs" Inherits="DanhMuc_DanhMucKhachHangSanPhamChuyenGia" %>
              ...
              xmlhttp.onreadystatechange = function () {
                  if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                      if (xmlhttp.responseText != "") {
                          ...
                          $("#ContentPlaceHolder1_txtTenKhachCu").autocomplete({

                              minLength: 0,
                              source: listKhachHangAutocomplete,
                              focus: function (event, ui) {
                                  $("#ContentPlaceHolder1_txtTenKhachCu").val(ui.item.label);
                                  return false;
                              },
                              select: function (event, ui) {
                                  $("#ContentPlaceHolder1_txtTenKhachCu").val(ui.item.value);
                                  $("#ContentPlaceHolder1_txtIDKhachHangCu").val(ui.item.id);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <!-- Main content -->
    <div class="title" id="dvTitle" runat="server">CHUYỂN GIÁ HÀNG HÓA</div>
    <div class="title1"><a href="DanhMucKhachHangSanPham.aspx"><i class="fa fa-step-backward"></i> Danh sách giá hàng hóa theo khách hàng</a></div>
            ...
            <form class="form-horizontal" runat="server">
               <div class="form-group">
                    <div class="row">
                        ...
                        <div class="coninput1">
                          <div class="titleinput"><b>Lấy giá từ khách(*):</b></div>
                          <div class="txtinput">
                              <input class="form-control" data-val="true" data-val-required="" id="txtTenKhachCu" runat="server" name="Content.ContentName" type="text" value="" placeholder="--Chọn--" />
                                <input id="txtIDKhachHangCu" type="hidden" runat="server" name="Content.ContentName" />
                          </div>
                        </div>
                        <div class="coninput2">
                          <div class="titleinput"><b>Gán cho khách(*):</b></div>
                          <div class="txtinput">
                ...
                <div class="box-footer">
                    <asp:Button ID="btLuu" runat="server" Text="CHUYỂN" class="btn btn-primary btn-flat" OnClick="btLuu_Click" />
