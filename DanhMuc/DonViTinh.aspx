<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DonViTinh.aspx.cs" Inherits="DanhMuc_DonViTinh" %>
    ...
    <script>
        ...
        function DeleteDonViTinh(IDDonViTinh)
        {
            ...
            {              
                ...
                xmlhttp.open("GET", "../Ajax.aspx?Action=DeleteDonViTinh&IDDonViTinh=" + IDDonViTinh, true);
                xmlhttp.send();
            }
        }
        //
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">DANH MỤC SIZE</div>
    <div class="box">
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <a class="btn btn-primary btn-flat" href="DonViTinh-CapNhat.aspx"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Thêm mới</a>
                </div>
                <div class="col-sm-3">
