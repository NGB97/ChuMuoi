<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DanhMucKhachHangSanPham-CapNhat.aspx.cs" Inherits="DanhMuc_DanhMucKhachHangSanPham_CapNhat" %>
      ...
      <script>
        ...
        %>
          ...
          function listsanpham() {
              ...
              xmlhttp.open("GET", "../Ajax5.aspx?Action=listsanpham", true);
              xmlhttp.send();
          }
          ...
          function TinhTienSo(IDLoaiHangHoa) {
              ...
              xmlhttp.open("GET", "../Ajax5.aspx?Action=TinhTienSo&Gia=" + gia + "&IDLoaiHangHoa=" + IDLoaiHangHoa, true);
              xmlhttp.send();
            ...
            <form class="form-horizontal" runat="server">
               <div class="form-group">
                ...
                <div class="box-footer">
                     <a class="btn btn-primary btn-flat" href="../DanhMuc/DanhMucKhachHangSanPham.aspx"><i class="glyphicon glyphicon-chevron-left"></i> Quay lại</a>
