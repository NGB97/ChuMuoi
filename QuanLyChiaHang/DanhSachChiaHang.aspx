<%@ Page Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="DanhSachChiaHang.aspx.cs" Inherits="QuanLyChiaHang_DanhSachChiaHang" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        //                        $("#ContentPlaceHolder1_txtNhaCungCap").val(ui.item.value);
        //                        $("#ContentPlaceHolder1_hdNhaCungCap").val(ui.item.id);
        ...
        //        }
        //    }
        //    xmlhttp.open("GET", "../Ajax3.aspx?Action=LoadNhaCungCap", true);
        //    xmlhttp.send();
        //}
        function LoadNhaCungCap() {
            var xmlhttp;
                    ...
                    if (xmlhttp.responseText != "") {
                        ...
                        $("#ContentPlaceHolder1_txtMaPhieuNhap").autocomplete({
                            ...
                            select: function (event, ui) {
                                ...
                                $("#ContentPlaceHolder1_idMaPhieuNhap").val(ui.item.id);
    ...
    <form runat="server">
        <div class="content-wrapper" style="min-height: 580px;">
            ...
            <section class="content">
                <div class="title">QUẢN LÝ CHIA HÀNG</div>
                <div class="box">
                    <div class="box-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="coninput1">
                                    ...
                                    <div class="txtinput">
                                        <input class="form-control" data-val="true" data-val-required="" id="txtMaPhieuNhap" runat="server" name="Content.ContentName" value="" autocomplete="off" />
                                        <input type="hidden" runat="server" id="idMaPhieuNhap" />
<%--                                    <input class="form-control" data-val="true" data-val-required="" id="txtNhaCungCap" runat="server" name="Content.ContentName"  type="hidden" value="" placeholder="--- Chọn ---" />--%>
                                    </div>
                                </div>
                                <div class="coninput1">
                                    <div class="titleinput"><b>Nhà cung cấp:</b></div>
                                    <div class="txtinput">
                                         <input class="form-control" data-val="true" data-val-required="" id="txtNhaCungCap" runat="server" name="Content.ContentName"  value="" />
                                        <input id="hdNhaCungCap" runat="server" type="hidden" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="dvNguoiDung" runat="server">
                            <table class='table table-bordered table-striped'>
                                <tr>
                                    ...
                                    <th class='th'>Mã phiếu nhập
                                    </th>


                                    <th class='th'>Ngày lập phiếu
                                    </th>
