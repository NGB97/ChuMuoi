...
public partial class QuanLyXuatNhap_DanhMucNhapHang : System.Web.UI.Page
{
    ...
    private void SetPage()
    {
        ...
        sql += "select count(*) from PhieuNhap where '1' = '1' ";
        if (pMaLoaiHangHoa != "")
        {
    ...
    private void LoadDuAn()
    {
        ...
        string sql = "";
        sql += @"select * from( SELECT ROW_NUMBER() OVER(ORDER BY PhieuNhap.IDPhieuNhap desc)AS RowNumber,* FROM PhieuNhap where PhieuNhap.MaPhieuNhap not like N'%-XB' ";
        if (pMaLoaiHangHoa != "")
        {
