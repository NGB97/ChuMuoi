<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="PhieuTraNoNhaCungCap.aspx.cs" Inherits="DanhMuc_DanhMucKhachHangSanPham" %>
    ...
    <script>
        ...
        function DeleteKhachHangSanPham(IDChiTietGiaTheoKhach) {
            if (confirm("Bạn có muốn xóa không ?")) {
                ...
                xmlhttp.open("GET", "../Ajax.aspx?Action=DeletePhieuTraNoNhaCungCap&IDChiTietGiaTheoKhach=" + IDChiTietGiaTheoKhach, true);
                xmlhttp.send();
            }
        }
        //
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">DANH MỤC TRẢ NỢ CHO NHÀ CUNG CẤP</div>
    <div class="box">
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-sm-9">
                    <%--<a class="btn btn-primary btn-flat" href="PhieuTraNoNhaCungCap-CapNhat.aspx"><i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;&nbsp; Thêm mới</a>--%>
