<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="LoiNhuan2.aspx.cs" Inherits="QuanLyDoiTra_CongNo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        //
        function showChiTietLoiNhuan() {
            var TuNgay = $('#ContentPlaceHolder1_txtTuNgayBan').val();
            var DenNgay = $('#ContentPlaceHolder1_txtDenNgayBan').val();
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    if (xmlhttp.responseText != "False") {
                        MoXemBaoDuong();
                        $('#dvXemBaoDuong').html(xmlhttp.responseText);
                    }
                    else {
                        alert("Hãy chọn đủ từ ngày đến ngày !")
                    }

                }
            }
            xmlhttp.open("GET", "../Ajax.aspx?Action=showChiTietLoiNhuan&TuNgay=" + TuNgay + "&DenNgay=" + DenNgay, true);
            xmlhttp.send();
        }
        //
    ...
    <div id="lightXemBaoDuong" class="white_content" style=" top: 10%; width: 70%; left: 15%; height: 80%;">
        <div class="box">
            <div id="dvBaoDuong" class="box-body">
                <div style="text-align:center; font-weight:bold; padding:10px"></div>
