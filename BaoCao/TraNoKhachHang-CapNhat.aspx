<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="TraNoKhachHang-CapNhat.aspx.cs" Inherits="DanhMuc_DanhMucKhachHangSanPham_CapNhat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <!-- Main content -->
    <div class="title" id="dvTitle" runat="server">THÊM THÔNG TIN TRẢ NỢ KHÁCH HÀNG</div>
        <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
    <div class="title1"><a href="TraNoKhachHang.aspx"><i class="fa fa-step-backward"></i> Danh sách nợ khách hàng</a></div>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="dvnull">&nbsp;</div>
                        <div class="coninput1">
                          <div class="titleinput"><b>Số tiền trả khách(*):</b></div>
                          <div class="txtinput">
