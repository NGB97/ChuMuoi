<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="TonKho.aspx.cs" Inherits="BaoCao_BaoCaoXuatNhapTon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">TỒN KHO HÀNG HÓA</div>
    <div class="box">
        <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="coninput1">
                          <div class="titleinput"><b>Từ ngày đầu kỳ:</b></div>
                          <div class="txtinput">
                                <input class="form-control" placeholder="--Chọn--" data-val="true" data-val-required="" id="txtNgayDauKy" runat="server" name="Content.ContentName" type="text" value=""  />
                          </div>
                        </div>
                        <div class="coninput1">
                          <div class="titleinput"><b>Đến ngày cuối kỳ:</b></div>
                          <div class="txtinput">
                               <input class="form-control" data-val="true" placeholder="--Chọn--" data-val-required="" id="txtNgayCuoiKy" runat="server" name="Content.ContentName" type="text" value=""  />
                          </div>
                        </div>
                      </div>
                </div>
