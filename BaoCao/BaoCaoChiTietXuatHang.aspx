<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/MasterPage.master" AutoEventWireup="true" CodeFile="BaoCaoChiTietXuatHang.aspx.cs" Inherits="BaoCao_BienBanGiaoHangMot" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">BÁO CÁO CHI TIẾT XUẤT HÀNG</div>
    <div class="box">
        <div class="box-body">
             ...
             <div class="form-group">
                    <div class="row">
                        <div class="dvnull">&nbsp;</div>
                        <div class="coninput1">
                          <div class="titleinput"><b>Từ ngày xuất:</b></div>
                          <div class="txtinput">
                       ...
                       <div class="coninput1">
                          <div class="titleinput"><b>Đến ngày xuất:</b></div>
                          <div class="txtinput">
