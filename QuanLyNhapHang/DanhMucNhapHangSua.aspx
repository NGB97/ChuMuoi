...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <!-- Main content -->
        <div class="title" id="dvTitle" runat="server">THÔNG TIN NHẬP HÀNG</div>
        <div class="title1"><a href="DanhMucNhapHang.aspx"><i class="fa fa-step-backward"></i>Danh sách phiếu nhập hàng</a></div>
                    ...
                    <form class="form-horizontal" runat="server">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="coninput2">
                                    <div class="titleinput"><b>Ngày Tạo Phiếu Nhập(*):</b></div>
                                    <div class="txtinput">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="dvnull">&nbsp;</div>
                                <div class="coninput1">
                                    <div class="titleinput"><b>Nhập từ nhà cung cấp(*):</b></div>
                                    <div class="txtinput">
                                ...
                                <div class="coninput2">
                                    <div class="titleinput"><b>Nhập vào kho(*):</b></div>
                                    <div class="txtinput">
                        ...
                        <div class="box">
                            ...
                            <h4 style="text-align: center; font-weight: bold; color: #0084d2; padding: 10px">THÊM HÀNG HÓA</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <a style='cursor: pointer;' class='btn btn-primary btn-flat' onclick='InPhieuTongHopNhapHang("<%=Request.QueryString["IDPhieuNhap"].ToString().Trim()%>");'>IN PHIẾU NHẬP HÀNG</a>
                                </div>
                                <%--start --%>
                                <div id="hh">
                                </div>
    ...
    <div id="lightXemDungCu" class="white_content" style="top: 10%; width: 70%; left: 15%; height: 80%;">
        <div class="box">
            <div id="dvDungCu" class="box-body">
                <h4 style="text-align: center; font-weight: bold; color: #0084d2; padding: 10px" id="titleThemHangHoa">THÊM CHI TIẾT HÀNG HÓA</h4>
                <div id="dvXemDungCu" style="padding: 10px; text-align: center">
                    ...
                    <div class="form-group" style="display: none;">
                        <div class="row">
                            ...
                            <div class="coninput1">
                                <div class="titleinput"><b>Ngày nhập chi tiết:</b></div>
                                <div class="txtinput">
