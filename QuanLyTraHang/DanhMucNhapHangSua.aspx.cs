    ...
    private void LoadPhieuNhap()
    {
        if (pIDPhieuNhap != "")
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                txtIDNCC.Value = table.Rows[0]["idKhachHang_TraHang"].ToString();
                txtTenNCC.Value = StaticData.getField("KhachHang", "TenKhachHang", "idKhachHang", table.Rows[0]["idKhachHang_TraHang"].ToString());
